(ns hyperphor.multitool.core
  ...
  #?(:cljs (:require-macros
            ...
            [hyperphor.multitool.core :refer [doseq* ignore-errors]])
...
;;; (things that are more for stats or geometry are in hyperphor.multitool.math)
